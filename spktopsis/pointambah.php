...
$carikode = $koneksi->query("SELECT id_poin FROM tab_poin ORDER BY id_poin DESC LIMIT 1");
$datakode = $carikode->fetch_array();
$jumlah_data = $datakode['id_poin'];
...
<body>
              ...
              <div class="">
                ...
                <form class="form" action="pointambah.php" method="post">
                  <div class="form-group">
                    <input class="form-control" type="text" name="id_poin" value="<?php echo $jumlah_data ?>" readonly>
                  </div>
                  <div class="form-group">
  ...
  <?php
    ...
    if (isset($_POST['simpan'])) {
      ...
      $sql = "INSERT INTO tab_poin (id_poin, poin) VALUES ('$id_poin', '$poin')";
