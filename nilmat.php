                          ...
                          <div class="form-group">
                            <select class="form-control" name="nilai">
                              ...
                              while ($datapoin = $poin->fetch_array()) {
                                echo "<option value=\"$datapoin[poin]\">$datapoin[poin]</option>\n";
                              }
                              ?>
                            </select>
                          </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            $sql = $koneksi->query("SELECT *
                  ...
                  ORDER BY tab_topsis.id_alternatif, tab_topsis.id_kriteria ASC"); // Mengurutkan berdasarkan id_alternatif dan id_kriteria
            ?>
            <table class="table table-striped table-bordered table-hover">
              <thead>
                <tr>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form class="form" action="hapusnilmat.php" method="post">
              <div class="form-group">
